...
class FillPermissionsForTypeinstitution extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeinstitution constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.typeinstitution',
            'admin.typeinstitution.index',
            'admin.typeinstitution.create',
            'admin.typeinstitution.show',
            'admin.typeinstitution.edit',
            'admin.typeinstitution.delete',
            'admin.typeinstitution.bulk-delete',
        ]);
