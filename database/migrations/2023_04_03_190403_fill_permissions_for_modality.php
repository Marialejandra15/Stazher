...
class FillPermissionsForModality extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModality constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.modality',
            'admin.modality.index',
            'admin.modality.create',
            'admin.modality.show',
            'admin.modality.edit',
            'admin.modality.delete',
            'admin.modality.bulk-delete',
        ]);
